...
|--------|---------|----------|
| [`cli`](cli.md) | Command-line interface for PyDoc2Markdown. | 6 function(s) |
...
| Module | Summary | Contents |
|--------|---------|----------|
| [`config`](core/config.md) | Configuration loader for PyDoc2Markdown. | 1 function(s) |
| [`crossref`](core/crossref.md) | Cross-referencing utilities for linking project-defined types. | 2 class(es), 1 function(s) |
...
| [`watcher`](core/watcher.md) | File watcher for auto-regenerating documentation. | 1 function(s) |
...
| Module | Summary | Contents |
|--------|---------|----------|
| [`helpers`](utils/helpers.md) | Helper utilities for PyDoc2Markdown. | 2 function(s) |
